...
function ChatView() {
    ...
    return (
        <div className="relative h-[70vh] md:h-[85vh] flex flex-col bg-gray-900 rounded-xl md:rounded-2xl overflow-hidden">
            {/* Chat Messages */}
            <div className="flex-1 overflow-y-auto scrollbar-hide p-4">
                <div className="max-w-4xl mx-auto space-y-4">
                    {previewError && (
                        <div className="p-4 rounded-lg bg-red-900/20 border border-red-500/60 mb-2">
                            <p className="text-sm text-red-200 font-medium mb-2">
                                The preview is currently showing an error. TechWiser can try to fix it automatically.
                            </p>
                            <button
                                onClick={onFixPreviewError}
                                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-red-500 hover:bg-red-600 text-white text-sm font-semibold transition-colors"
                            >
                                <ArrowRight className="h-4 w-4" />
                                Ask AI to fix preview error
                            </button>
                        </div>
                    )}
            ...
            {/* Input Section */}
            <div className="border-t border-gray-800 bg-gray-900/70 backdrop-blur-sm p-4">
                <div className="max-w-4xl mx-auto">
                    <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-4">
                        <div className="flex gap-3">
                            <textarea
                                placeholder="Tell TechWiser in simple words what kind of website you want (who it is for, what pages you need, colours, style). No technical terms needed."
                                value={userInput}
